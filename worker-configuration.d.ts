/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 32f01195571ffcf3476ee5a4768fe7c5)
...
interface __BaseEnv_Env {
	...
	ARTICLE_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/server").ArticleGenerationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "OnboardingChatAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATAFORSEO_API_KEY" | "AUTH_MODE" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_SECRET">> {}
}
