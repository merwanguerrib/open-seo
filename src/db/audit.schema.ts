...
// One row per internal link (graph edge) discovered during the crawl, feeding
// the audit-graph visualization (separate from `auditLinks`, which backs the
// issue engine's broken/nofollow link checks).
